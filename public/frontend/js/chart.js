...
$(function () {
  ...
  if (dual !== null) {
    const bcd = JSON.parse($('#dual-line').attr('data-chat'))
    const labels = JSON.parse($('#dual-line').attr('data-lable'))
  ...
  if (ctx !== null) {
    const bcd = JSON.parse($('#linechart').attr('data-chat'))
    const labels = JSON.parse($('#linechart').attr('data-lable'))
  ...
  if (line !== null) {
      const bcd = JSON.parse($('#line').attr('data-chat'))
      const labels = JSON.parse($('#line').attr('data-lable'))
...
if (barX !== null) {
  const bcd = JSON.parse($('#barChart').attr('data-chat'))
 const labels = JSON.parse($('#barChart').attr('data-month'))
